                    ...
                    return <div key={index} className='bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] -z-10'>
                        <div className='flex flex-col md:flex-row gap-10 justify-center h-[600px] my-10 md:my-0 items-center px-4'>
                            <div className='md:space-y-6 space-y-3'>
                                <h3 className='text-red-500 font-semibold font-sans text-sm'>Powering Your World with the Best in Ecommerce</h3>
                             ...
                             <div>
                                <img src={item.images[0]} alt={item.title} className='rounded-full w-[450px] hover:scale-105 transition-all shadow-2xl shadow-red-400'/>
                            </div>
                        </div>
                    </div>
                })
